        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td style="color: white;"><?php echo $row['country']; ?></td>
                    <td style="color: white;"><?php echo $row['currency']; ?></td>
                    <td style="color: white;"><a href="update.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a></td>
                    <td style="color: white;"><a href="delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
